...
void solve() {
  ...
  cout << "mul 9" << endl;
  int ret1; cin >> ret1; assert(ret1 == 1);

  cout << "digit" << endl;
  int ret2; cin >> ret2; assert(ret2 == 1);

  cout << "digit" << endl;
  int ret3; cin >> ret3; assert(ret3 == 1);

  int d = n - 9;
  cout << "add " << d << endl;
  int ret4; cin >> ret4; assert(ret4 == 1);

  cout << "!" << endl;
  int ret5; cin >> ret5; assert(ret5 == 1);
